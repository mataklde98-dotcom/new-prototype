import { imgButtonGroup1 } from "./svg-2nwku";

export default function ButtonGroup() {
  return (
    <div className="content-stretch flex gap-[12px] items-center px-[4px] relative rounded-[296px] size-full" data-name="Button Group 1">
      ...
      <div className="-translate-y-1/2 absolute h-[44px] left-0 right-0 top-1/2" data-name="BG">
        <div className="absolute inset-[-26px] opacity-67" data-name="Blur">
          <div className="-translate-x-1/2 -translate-y-1/2 absolute blur-[10px] left-1/2 mask-intersect mask-luminance mask-no-clip mask-no-repeat mask-position-[-76px_-76px] mask-size-[200px_200px] rounded-[1000px] size-[48px] top-1/2" style={{ maskImage: `url('${imgButtonGroup1}')` }} data-name="Blur">
