Klar Bruder, ich schreibe dir das einmal sauber formatiert und korrekt strukturiert, damit du es direkt copy-pasten kannst (z. B. für Doku, Swagger, Notion oder Figma Prompt).
...
Wenn du willst, kann ich dir das auch noch als:
	...
	•	🔹 Markdown API-Dokumentation
	•	🔹 Developer-Ready Backend Spec
	•	🔹 oder Figma Make Prompt optimiert
