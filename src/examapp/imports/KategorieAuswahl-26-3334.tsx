import svgPaths from "./svg-st71xhd5x6";
import { imgG6015 } from "./svg-urqgs";
...
function Frame23() {
  return (
    <div className="absolute bg-[#2b2b30] h-[46px] left-[22px] overflow-clip rounded-[12px] top-[675px] w-[333px]">
      <p className="absolute font-['Poppins:Regular',sans-serif] leading-[1.2] left-[143.5px] not-italic text-[#e3e3e3] text-[12px] text-center text-nowrap top-[16px] translate-x-[-50%]">Kategorie oder Thema fehlt? Mit KI erstellen</p>
      <div className="absolute h-[13px] left-[311px] top-[16px] w-[7px]">
        <div className="absolute inset-[-5.77%_-15.75%_-5.77%_-10.71%]">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 8.85221 14.5">
            <path d={svgPaths.p395af80} id="Vector 125" stroke="var(--stroke-0, white)" strokeLinecap="round" strokeWidth="1.5" />
          </svg>
