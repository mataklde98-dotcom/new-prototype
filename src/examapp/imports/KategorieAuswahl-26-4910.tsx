import svgPaths from "./svg-3mdrbs0jk2";
import { imgG6015 } from "./svg-93wsa";
...
function Frame18() {
  return (
    <div className="absolute bg-[#2b2b30] border border-[#484848] border-solid h-[54px] left-[22px] overflow-clip rounded-[8px] top-[82px] w-[289px]">
      <p className="absolute font-['Poppins:Medium',sans-serif] leading-[16px] left-[58px] not-italic text-[17px] text-white top-[17px] w-[184px]">Categorie</p>
    </div>
  );
}
...
function Section10() {
  return (
    <div className="absolute contents left-[22px] top-[82px]" data-name="Section 5">
      <Frame18 />
    </div>
  );
}
...
function IconFlashOn() {
  return (
    <div className="absolute inset-[19.47%_46.55%_77.86%_51.35%]" data-name="🦆 icon 'flash on'">
...
function Group8() {
  return (
    <div className="absolute contents left-[22px] top-[82px]">
      <Section10 />
      <IconFlashOn />
...
function Frame24() {
  return (
    <div className="absolute bg-[#2b2b30] h-[524px] left-[22px] overflow-clip rounded-[12px] top-[197px] w-[333px]">
      <Group8 />
      <p className="absolute font-['Poppins:Regular',sans-serif] leading-[1.2] left-[166.5px] not-italic text-[#e3e3e3] text-[14px] text-center top-[27px] translate-x-[-50%] w-[259px]">Eine neue Kategorie mit neuen Themeninhalten wurde erstellt</p>
      <Btn />
    </div>
  );
}
