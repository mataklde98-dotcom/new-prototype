import svgPaths from "./svg-8p9ly9rxtr";
import { imgG6015 } from "./svg-logej";
...
function Frame11() {
  return (
    <div className="absolute bg-[#2b2b30] border border-[#484848] border-solid h-[54px] left-[22px] opacity-50 overflow-clip rounded-[8px] top-[203px] w-[333px]">
      <p className="absolute font-['Poppins:Medium',sans-serif] leading-[16px] left-[94px] not-italic text-[17px] text-white top-[17px] w-[209px]">Topic Example</p>
      <Frame3 />
    </div>
  );
}
...
function Component775923CountryFlagGermanGermanyNationalIcon() {
  return (
    <div className="absolute h-[19.636px] left-[74px] opacity-50 overflow-clip top-[218.95px] w-[24px]" data-name="775923_country_flag_german_germany_national_icon 1">
      <Layer />
    </div>
  );
}
...
function Frame12() {
  return (
    <div className="absolute bg-[#2b2b30] border border-[#484848] border-solid h-[54px] left-[22px] opacity-50 overflow-clip rounded-[8px] top-[270px] w-[333px]">
      <p className="absolute font-['Poppins:Medium',sans-serif] leading-[16px] left-[94px] not-italic text-[17px] text-white top-[17px] w-[209px]">Topic Example</p>
      <Frame4 />
    </div>
  );
...
function Component775923CountryFlagGermanGermanyNationalIcon1() {
  return (
    <div className="absolute h-[19.636px] left-[74px] opacity-50 overflow-clip top-[285.95px] w-[24px]" data-name="775923_country_flag_german_germany_national_icon 1">
      <Layer1 />
    </div>
  );
}
...
function Frame13() {
  return (
    <div className="absolute bg-[#2b2b30] border border-[#484848] border-solid h-[54px] left-[22px] opacity-50 overflow-clip rounded-[8px] top-[538px] w-[333px]">
      <p className="absolute font-['Poppins:Medium',sans-serif] leading-[16px] left-[94px] not-italic text-[17px] text-white top-[17px] w-[209px]">Topic Example</p>
      <Frame5 />
    </div>
  );
...
function Component775923CountryFlagGermanGermanyNationalIcon2() {
  return (
    <div className="absolute h-[19.636px] left-[74px] opacity-50 overflow-clip top-[553.95px] w-[24px]" data-name="775923_country_flag_german_germany_national_icon 1">
      <Layer2 />
    </div>
  );
}
...
function Frame14() {
  return (
    <div className="absolute bg-[#2b2b30] border border-[#484848] border-solid h-[54px] left-[22px] opacity-50 overflow-clip rounded-[8px] top-[471px] w-[333px]">
      <p className="absolute font-['Poppins:Medium',sans-serif] leading-[16px] left-[94px] not-italic text-[17px] text-white top-[17px] w-[209px]">Topic Example</p>
      <Frame6 />
    </div>
  );
...
function Component775923CountryFlagGermanGermanyNationalIcon3() {
  return (
    <div className="absolute h-[19.636px] left-[74px] opacity-50 overflow-clip top-[486.95px] w-[24px]" data-name="775923_country_flag_german_germany_national_icon 1">
      <Layer3 />
    </div>
  );
}
...
function Frame15() {
  return (
    <div className="absolute bg-[#2b2b30] border border-[#484848] border-solid h-[54px] left-[21px] opacity-50 overflow-clip rounded-[8px] top-[404px] w-[333px]">
      <p className="absolute font-['Poppins:Medium',sans-serif] leading-[16px] left-[94px] not-italic text-[17px] text-white top-[17px] w-[209px]">Topic Example</p>
      <Frame7 />
    </div>
  );
...
function Component775923CountryFlagGermanGermanyNationalIcon4() {
  return (
    <div className="absolute h-[19.636px] left-[73px] opacity-50 overflow-clip top-[419.95px] w-[24px]" data-name="775923_country_flag_german_germany_national_icon 1">
      <Layer4 />
    </div>
  );
}
...
function Section7() {
  return (
    <div className="absolute contents left-[21px] top-[404px]" data-name="Section 5">
      <Frame15 />
...
function Group9() {
  return (
    <div className="absolute contents left-[21px] top-[404px]">
      <Section7 />
    </div>
  );
}
...
function Frame16() {
  return (
    <div className="absolute bg-[#2b2b30] border border-[#484848] border-solid h-[54px] left-[22px] opacity-50 overflow-clip rounded-[8px] top-[605px] w-[333px]">
      <p className="absolute font-['Poppins:Medium',sans-serif] leading-[16px] left-[94px] not-italic text-[17px] text-white top-[17px] w-[209px]">Topic Example</p>
      <Frame8 />
    </div>
  );
...
function Component775923CountryFlagGermanGermanyNationalIcon5() {
  return (
    <div className="absolute h-[19.636px] left-[74px] opacity-50 overflow-clip top-[620.95px] w-[24px]" data-name="775923_country_flag_german_germany_national_icon 1">
      <Layer5 />
    </div>
  );
}
...
function Btn() {
  return (
    <div className="absolute bg-[#009379] content-stretch flex h-[46px] items-center justify-center left-[22px] px-[144px] py-[13px] rounded-[12px] top-[673px] w-[333px]" data-name="Btn">
...
function Frame17() {
  return <div className="absolute bg-[#2b2b30] border border-[#009379] border-solid h-[54px] left-[22px] rounded-[8px] shadow-[0px_0px_27.3px_0px_rgba(0,147,121,0.35)] top-[337px] w-[333px]" />;
}

function Frame9() {
  return <div className="absolute bg-[#009379] left-[34px] rounded-[5px] size-[23px] top-[352px]" />;
}
...
function Section9() {
  return (
    <div className="absolute contents left-[22px] top-[337px]" data-name="Section 5">
      <Frame17 />
      <p className="absolute font-['Poppins:Medium',sans-serif] leading-[16px] left-[117px] not-italic text-[17px] text-white top-[355px] w-[209px]">Topic Example</p>
      <Frame9 />
...
export default function KategorieThemen() {
  return (
    <div className="bg-[#0a0a0a] overflow-clip relative rounded-[50px] size-full" data-name="Kategorie - Themen">
      <Section />
      <Section6 />
      <Group4 />
      <Group5 />
      ...
      <p className="absolute font-['Poppins:Medium',sans-serif] leading-[normal] left-[26px] not-italic text-[#979797] text-[14px] text-nowrap top-[109px]">Select a Topic</p>
      <NavigationBar />
    </div>
  );
}