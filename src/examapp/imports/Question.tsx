import svgPaths from "./svg-4m8tzjbc0q";
...
function Group7() {
  return (
    <div className="absolute contents left-[27px] top-[134px]">
      ...
      <div className="absolute bg-white h-[11px] left-[232px] rounded-[13px] top-[134px] w-[36px]" />
    ...
    <div className="absolute inset-[10.71%_60.27%_86.7%_34.13%]" data-name="Group">
      <div className="absolute inset-[-7.14%]">
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24 24">
          <g id="Group">
            <path d={svgPaths.p1f1b6800} id="Vector" stroke="var(--stroke-0, white)" strokeWidth="3" />
            <path d={svgPaths.p2edd2b80} id="Vector_2" stroke="var(--stroke-0, white)" strokeLinecap="round" strokeWidth="3" />
          </g>
        </svg>
      </div>
    </div>
...
function Group6() {
  return (
    <div className="absolute contents left-[128px] top-[75px]">
      <p className="absolute font-['Poppins:SemiBold',sans-serif] leading-[normal] left-[158px] not-italic text-[30px] text-nowrap text-white top-[75px]">09:45</p>
      <Group />
    </div>
  );
}
...
function Frame7() {
  return <div className="absolute bg-[#2b2b30] border border-[#b4b4b4] border-solid h-[54px] left-[22px] rounded-[8px] top-[495px] w-[333px]" />;
}

function Frame3() {
  return <div className="absolute bg-[#bcbcbc] left-[34px] rounded-[5px] size-[23px] top-[510px]" />;
}
...
function Section3() {
  return (
    <div className="absolute contents left-[22px] top-[495px]" data-name="Section 5">
      <Frame7 />
      <p className="absolute font-['Poppins:Medium',sans-serif] leading-[16px] left-[77px] not-italic text-[17px] text-white top-[513px] w-[209px]">Choice</p>
      <Frame3 />
...
export default function Question() {
  return (
    <div className="bg-[#0a0a0a] overflow-clip relative rounded-[50px] size-full" data-name="Question">
      <Section2 />
      <Group7 />
      <Group6 />
      <Group3 />
